...
Algoritma ini dipecah menjadi **5 flowchart** agar mudah dibaca pada kertas A4:

| Flowchart | Fungsi |
|---|---|
| **3a** | Pemrosesan data & mapping arah jam |
| **3b** | Percabangan mode aplikasi (entry point) |
| **3c** | Jalur A — Deteksi objek dekat (ToF ≤ 4m) |
| **3d** | Jalur B — Deteksi kendaraan jauh (YOLO > 4m) |
| **3e** | Jalur C — Deteksi medan (tangga / lubang) |
